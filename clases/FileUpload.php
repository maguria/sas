...
class FileUpload {
    ...
    private $destino="./", $nombre="", $tamaño=10000000000000000000,$parametro,$extension,$error=false, $politica = self::RENOMBRAR,$errorCode;
//tipo, archivos
    ...
    public function upload(){
      ...
      static function uploadMulti($param, $destino,$nombre){
          ...
          for($i=0;$i<count($cambioArray);$i++){
              ...
              $sube->setPolitica(FileUpload::RENOMBRAR);
              $sube->upload();
